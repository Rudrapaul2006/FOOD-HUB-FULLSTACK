...
orderRoute.post("/verifypayment" , isAuth , verifyPayment)
...
orderRoute.post("/orderSingleFood/:id", isAuth , singleFoodOrder) // single food order from cheakout page 

orderRoute.post("/singleOnlineOrder/:id", isAuth , singleOnlineOrder)
